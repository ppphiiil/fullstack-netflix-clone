        ...
        <div className="VideoItem-container">
            ...
            <div className="VideoItem-detail-container">
                <div className="VideoItem-icon-container">
                    <div>
                        <i class=" fa-2x fas fa-play-circle"></i>
                        <i class=" fa-2x far fa-arrow-alt-circle-up"></i>
                        <i class=" fa-2x far fa-arrow-alt-circle-down"></i>
                    </div>
                ...
                <div className="VideoItem-details">
                    <div className="VideoItem-detail-season" style={ { color: "#808080" } }>
                        <p style={ { color: "#46d369" } }>98% match</p><div className="VideoItem-detail-season">
                            <p>12 Seasons</p><p>16</p> <p>2017</p>
                        </div></div>
                    <p className="VideoItem-detail-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem enim  sdfsfs fd sdfsdfs df</p>
